...
intro_df <- read.csv("inst/extdata/WI_NWISdata.csv")
head(intro_df)
str(intro_df)
dim(intro_df)
summary(intro_df)
...
```{r, eval=FALSE}
str(read.csv("inst/extdata/WI_NWISdata.csv"))
str(read.csv("inst/extdata/WI_NWISdata.csv", stringsAsFactors=FALSE))
```
...
```{r}
intro_df <- read.csv("inst/extdata/WI_NWISdata.csv", stringsAsFactors = FALSE, 
